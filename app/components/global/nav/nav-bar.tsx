                        ...
                        return isOpen ? (
                            <Link 
                                ...
                                className={`group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${
                                    isActive 
                                        ? 'bg-[#608858] text-white shadow-lg shadow-[#608858]/30' 
                                        : 'text-gray-700 hover:bg-gray-100 hover:text-[#608858]'
                                }`}
                            >
                                <div className={`${isActive ? 'text-white' : 'text-gray-500 group-hover:text-[#608858]'}`}>
                                    {item.icon}
                                </div>
                            ...
                            <Link 
                                ...
                                className={`group relative flex items-center justify-center p-3 rounded-xl transition-all duration-200 ${
                                    isActive 
                                        ? 'bg-[#608858] text-white shadow-lg' 
                                        : 'text-gray-500 hover:bg-gray-100 hover:text-[#608858]'
                                }`}
                                title={item.name}
                            >
                                {item.icon}
                ...
                <div className={`p-4 ${isOpen ? '' : 'flex justify-center'}`}>
                    {isOpen ? (
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#608858] to-[#4a6b44] flex items-center justify-center text-white font-bold shadow-md">
                        ...
                        <div className="flex flex-col gap-2">
                            <Link 
                                ...
                                title="Ustawienia"
                            >
                                <SettingsIcon className="w-5 h-5 text-gray-500 hover:text-[#608858]" />
                            </Link>
                            <Link 
                                href="/wyloguj" 
                                className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
