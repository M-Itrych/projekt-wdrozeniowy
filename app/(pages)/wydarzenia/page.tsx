              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-3 rounded-lg transition-all ${
                    isSelected
                      ? "bg-[#608858] text-white shadow-lg scale-105"
                      : isToday
                      ? "bg-white border-2 border-[#608858] text-[#608858]"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-4 flex items-center justify-between">
            ...
            {selectedDateEvents.length > 0 && (
              <span className="bg-[#608858] text-white text-sm px-3 py-1 rounded-full">
            ...
            <div className="space-y-4">
              {selectedDateEvents.map((event) => {
                ...
                return (
                  <div
                    key={event.id}
                    className={`bg-white rounded-lg border-2 ${event.color} overflow-hidden shadow-sm hover:shadow-md transition-shadow`}
                  >
                    <div className="p-6">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              <Clock className="w-4 h-4 text-[#608858]" />
                              <span>{event.time}</span>
                            </div>
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              <MapPin className="w-4 h-4 text-[#608858]" />
                              <span>{event.location}</span>
                            </div>
                            {event.participants && (
                              <div className="flex items-center gap-2 text-sm text-gray-600">
                                <Users className="w-4 h-4 text-[#608858]" />
