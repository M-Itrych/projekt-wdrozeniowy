        ...
        <div className="h-screen bg-gray-50 dark:bg-gray-900 flex flex-col overflow-hidden">
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                <div className="flex justify-between items-center mb-4">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Płatności</h1>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="bg-[#005FA6] text-white px-4 py-2 rounded-lg hover:bg-[#005FA6] transition-colors flex items-center gap-2 shadow-md">
            ...
            <div className="flex-1 p-6">
                <div className="bg-white dark:bg-gray-800 h-full flex flex-col rounded-lg shadow-md overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h2 className="text-lg font-bold text-gray-900 dark:text-white">Historia płatności</h2>
                    </div>
                        ...
                        <Table>
                                ...
                                <TableRow>
                                    <TableHead>
                                        <Checkbox 
                                            ...
                                            className="data-[state=checked]:bg-[#005FA6] data-[state=checked]:border-[#005FA6] data-[state=checked]:text-white"
                                        />
                                    </TableHead>
                            ...
                            <TableBody>
                                {currentPayments.map((payment) => (
                                    <TableRow key={payment.id} className={selectedItems.includes(payment.id) ? 'bg-green-50 dark:bg-green-900/20' : ''}>
                                        <TableCell>
                                            <Checkbox 
                                        ...
                                        <TableCell className="max-w-xs">
                                            <div className="text-sm text-gray-900 dark:text-white">{payment.description}</div>
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <button className="text-[#005FA6] hover:text-[#005FA6] transition-colors">
