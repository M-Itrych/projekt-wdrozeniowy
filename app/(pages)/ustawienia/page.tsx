            ...
            <div className="flex-1 overflow-y-auto p-6">
                <div className="max-w-4xl mx-auto space-y-6">
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Informacje osobiste</h2>
                        
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center gap-4 flex-1">
                                    <div className="p-2 bg-[#005FA6] rounded-lg">
                                        <Mail className="w-5 h-5 text-white" />
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-sm text-gray-600 dark:text-gray-300">Adres e-mail</p>
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className="text-[#005FA6] hover:text-[#005FA6] text-sm font-medium flex items-center gap-1 cursor-pointer"
                                    >
                                        {showEmail ? (
                                            <>
                            ...
                            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center gap-4 flex-1">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm text-gray-600 dark:text-gray-300">Numer telefonu</p>
                                        <p className="text-base font-medium text-gray-900 dark:text-white">
                            ...
                            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center gap-4 flex-1">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm text-gray-600 dark:text-gray-300">Adres zamieszkania</p>
                                        <p className="text-base font-medium text-gray-900 dark:text-white">
                                            {userData.address}
                                        </p>
                                    </div>
